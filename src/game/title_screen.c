...
void title_screen_render(void) {
    ...
    /* Subtitle */
    if (title_anim & 32) {
        vn_text_draw_string(5, 3, "-------", TEXT_COLOR_GRAY);
    }
    ...
    /* Version text */
    vn_text_draw_string(1, 19, "v1.0", TEXT_COLOR_GRAY);
    ...
    for (i = 0; i < MENU_COUNT; i++) {
        ...
        if (i == menu_cursor) {
            ...
            if (title_anim & 16) {
                vn_text_draw_char(8, menu_y + i, '>', TEXT_COLOR_YELLOW);
            }
        }
        ...
        vn_text_draw_string(10, menu_y + i, menu_items[i], color);
    }
