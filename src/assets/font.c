 ...
 * Each row is 1 byte, MSB = leftmost pixel
 * Simplified but readable font for GBA visual novel
 */
const u8 font_data_8x8[95][8] = {
    ...
    /* 0x47 'G' */ {0x7C,0xC6,0xC0,0xC0,0xCE,0xC6,0x7E,0x00},
    ...
    /* 0x54 'T' */ {0xFE,0x18,0x18,0x18,0x18,0x18,0x18,0x00},
    ...
    /* 0x62 'b' */ {0xE0,0xC0,0xC0,0xF8,0xCC,0xCC,0xF8,0x00},
    /* 0x63 'c' */ {0x00,0x00,0x7C,0xC6,0xC0,0xC6,0x7C,0x00},
    /* 0x64 'd' */ {0x1C,0x0C,0x0C,0x7C,0xCC,0xCC,0x7C,0x00},
    /* 0x65 'e' */ {0x00,0x00,0x7C,0xC6,0xFE,0xC0,0x7C,0x00},
    /* 0x66 'f' */ {0x1C,0x36,0x30,0x78,0x30,0x30,0x78,0x00},
    /* 0x67 'g' */ {0x00,0x00,0x7C,0xCC,0xCC,0x7C,0x0C,0xF8},
    /* 0x68 'h' */ {0xE0,0xC0,0xC0,0xF8,0xCC,0xCC,0xCC,0x00},
    /* 0x69 'i' */ {0x18,0x00,0x38,0x18,0x18,0x18,0x3C,0x00},
    /* 0x6A 'j' */ {0x06,0x00,0x0E,0x06,0x06,0x66,0x66,0x3C},
    /* 0x6B 'k' */ {0xE0,0xC0,0xC0,0xCC,0xD8,0xF0,0xD8,0xCC},
    ...
    /* 0x70 'p' */ {0x00,0x00,0xF8,0xCC,0xCC,0xF8,0xC0,0xC0},
    /* 0x71 'q' */ {0x00,0x00,0x7C,0xCC,0xCC,0x7C,0x0C,0x0C},
